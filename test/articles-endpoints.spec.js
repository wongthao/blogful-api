...
describe.only('Articles Endpoints', function() {
    ...
    afterEach('cleanup', () => db('blogful_articles').truncate()) // this will leave the database in a clean state so there's less chance of a test leak. Ensuring we clean after each test will give any tests that happen after a better starting point.
